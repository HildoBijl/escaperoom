...
export function Action() {
	return <Line text="Je gaat terug naar het muzieklokaal" />
}
...
// 							<p>Je slaat je hoofd tegen de deur aan. Het heeft geen effect op de deur: die blijft dicht. Je krijgt er echter wel hoofdpijn van.</p>,
// 						])}
// 					</>
// 				case 'CS':
// 					return <>
