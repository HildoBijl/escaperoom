export function Location() {
	return <>
		...
		<p style={{ fontStyle: 'italic' }}>Dit is voorlopig het einde van de Escape Room. Het wiskundelokaal wordt, net als de lokalen erna, binnenkort toegevoegd. Dus komt snel weer terug!</p>
	</>
}
