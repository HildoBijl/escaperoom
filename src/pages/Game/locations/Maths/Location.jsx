...
export function Location({ numVisits }) {
	...
	return cases(numVisits, [0, 3, 6, Infinity], [
		<>
			<p>Het lokaal ziet er exact hetzelfde uit als toen je klas er nog was, behalve dan dat iedereen weg is. De tafels staan nog netjes in rijen door het lokaal, allen naar het schoolbord gericht, en de muren zijn nog steeds behangd met wiskundige posters.</p>
			<Image src={MathsRoom} />
