...
export function Location({ numVisits }) {
	return cases(numVisits, [0, 2, 3, 6, 7, Infinity], [
		<>
			<p>Terwijl je het muzieklokaal binnenloopt, kun je haast de stukken horen die de docent hier altijd met de klas speelt. Maar als je rondkijkt, valt je deze keer vooral de ijzige stilte op die in de ruimte heerst. Er is zeker niemand die nu muziek maakt.</p>
			<Image src={MusicRoom} />
