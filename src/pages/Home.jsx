...
export function Home() {
	return <Subpage>
		...
		<Image src={Office} />
		<p>De Escape Room is gericht op scholieren uit de onderbouw van de middelbare school die wel houden van raadsels, getallen, en een beetje uitdaging. Zit jij dit jaar of volgend jaar in klas 1 of 2 van het voortgezet onderwijs? En lukt het je om de Escape Room voor 13 juni 2025 op te lossen? Dan win je mogelijk een gratis plek voor een <Link to="https://www.vierkantvoorwiskunde.nl/">Vierkant voor Wiskunde</Link> zomerkamp! Zie de <Link to="/info">Infopagina</Link> voor details en voorwaarden.</p>
	</Subpage>
}
