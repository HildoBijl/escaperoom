...
export function Home() {
	return <Subpage>
		...
		<Alert severity="info">We raden aan om de Escape Room samen te doen. Dat is wel zo leuk! Als elke persoon de Escape Room op een eigen device (laptop, tablet, telefoon) doet, dan kan iedereen los rondlopen en hints zoeken, om vervolgens samen de raadsels op te lossen.</Alert>
	</Subpage>
}
