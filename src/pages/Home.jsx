...
export function Home() {
	return <Subpage>
		...
		<Alert severity="warning" sx={{ my: 2 }}>De deadline is uitgesteld: je kunt tot en met <strong>3 juli</strong> nog meedoen voor de prijzen!</Alert>
		<p>De Escape Room is gericht op scholieren uit de onderbouw van de middelbare school die wel houden van raadsels, getallen, en een beetje uitdaging. Zit jij dit schooljaar in klas 1, 2 of 3 van het voortgezet onderwijs? En lukt het je om de Escape Room uiterlijk <strong>3 juli 2025</strong> op te lossen? Dan win je mogelijk een gratis plek voor een <Link to="https://www.vierkantvoorwiskunde.nl/">Vierkant voor Wiskunde</Link> zomerkamp! Zie de <Link to="/info">Infopagina</Link> voor details en voorwaarden.</p>
